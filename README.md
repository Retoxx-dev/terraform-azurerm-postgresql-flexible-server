...
| <a name="input_configuration"></a> [configuration](#input\_configuration) | List of configuration objects for PostgreSQL Flexible Server | <pre>list(object({<br>    name  = string<br>    value = string<br>  }))</pre> | `[]` | no |
